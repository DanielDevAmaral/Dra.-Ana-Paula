...
const TableAnamnese = ({ pacienteDados }) => {
  console.log(pacienteDados);
  const anamneses = pacienteDados?.anamnese || [];
  // Verifica se existe algum item no array de pacienteDados
  const ultimaAnamnese =
    anamneses.length > 0 ? anamneses[anamneses.length - 1] : null;
  ...
  if (pacienteDados.sexo === "Masculino") {
    return (
        ...
        <React.Fragment key={ultimaAnamnese._id}>
          ...
          <Grid item xs={12} md={4}>
            ...
            >
              ...
              <AnamneseItem
                label="Comorbidade"
                value={ultimaAnamnese.comorbidade}
              />
              <AnamneseItem label="Plano" value={ultimaAnamnese.plano} />
              <AnamneseItem
                label="Alergias"
                value={ultimaAnamnese.alergia?.join(", ") || "Não informado"}
              />
              <AnamneseItem
                label="Pratica Esporte"
                value={ultimaAnamnese.esporte ? "Sim" : "Não"}
              />
              <AnamneseItem
                label="Fuma"
                value={ultimaAnamnese.fumo ? "Sim" : "Não"}
              />
            </Paper>
          </Grid>
          ...
          <Grid item xs={12} md={12}>
            <Paper
              ...
              sx={{
                ...
                boxShadow: "0px 4px 12px rgba(0, 0, 0, 0.1)",
                height: "180px",
                overflowY: "auto", // Rola apenas no eixo Y
                overflowX: "hidden", // Esconde a rolagem no eixo X
            ...
            >
              ...
              <p style={{ wordBreak: "break-word" }}>{ultimaAnamnese.observacao || "Não informado"}</p>
            </Paper>
          </Grid>
        </React.Fragment>
      </Grid>
        ...
        <React.Fragment key={ultimaAnamnese._id}>
          ...
          <Grid item xs={12} md={4}>
            ...
            >
              ...
              <AnamneseItem
                label="Gravidez"
                value={ultimaAnamnese.gravidez ? "Sim" : "Não"}
              />
              <AnamneseItem
                label="Amamenta"
                value={ultimaAnamnese.amamenta ? "Sim" : "Não"}
              />
            </Paper>
          </Grid>
